    ...
    Scaffold(
        ...
        if (moveNoteToTrashDialogShownState.value) {
            AlertDialog(
                ...
                title = {
                    Text("Move this contacts to the trash?")
                },
                text = {
                    Text(
                        "Are you sure you want to " +
                                "move this contacts to the trash?"
                    )
                },
                confirmButton = {
                    TextButton(onClick = {
        ...
        actions = {
            IconButton(onClick = onSaveNoteClick) {
                Icon(
                    ...
                    contentDescription = "Save Contacts Button",
                    tint = MaterialTheme.colors.onPrimary
                )
            }
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ContentTextField(
            ...
            onTextChange = { newName ->
                onNoteChange.invoke(note.copy(name = newName))
            }
        )
        ...
        ContentTextField(
            ...
            onTextChange = { newPhoneNumber ->
                onNoteChange.invoke(note.copy(phoneNumber = newPhoneNumber))
            }
        )
